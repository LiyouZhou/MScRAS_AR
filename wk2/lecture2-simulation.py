...
#  1. State: the board/maze (line 41)
#  2. Agent: a basic learning agent (state value iteration) (line 102)
#  3. IRLAgent: a basic IRL agent, to be extended/modified (line 194)
#
